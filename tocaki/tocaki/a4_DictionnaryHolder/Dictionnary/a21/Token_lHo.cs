...
public class Token_lHo : LexicalToken
{
    public override List<Type> ParentConcepts { get => []; }
    public override string Phonetics { get => "lHo"; }
    public override string DefinitionInTocaki { get => "Possessif pluriel de ji (ja⋃ri)"; }
